...
func (topology *provider) initRoutes(routes httpserver.Router) error {
	...
	routes.GET("/api/apm/topology/search/tagv", topology.searchTagv /*, GetTopologyPermission(topology.db)*/)
	routes.GET("/api/apm/topology", topology.topology /*, GetTopologyPermission(topology.db)*/)
	routes.GET("/api/apm/topology/overview", topology.overview /*, GetTopologyPermission(topology.db)*/)
	routes.GET("/api/apm/topology/services", topology.services /*, GetTopologyPermission(topology.db)*/)
