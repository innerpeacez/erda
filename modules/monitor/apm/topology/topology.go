...
import (
	...
	"github.com/erda-project/erda/modules/monitor/apm"
	"github.com/olivere/elastic"
	"terminus.io/dice/monitor/modules/common/db"
	"terminus.io/dice/monitor/modules/common/permission"
...
func (topology *provider) GetSearchTags(r *http.Request) []SearchTag {
	lang := api.Language(r)
	label := topology.i18n.Text(lang, ApplicationSearchTag.Tag)
	if label != "" {
...
func (topology *provider) GetTopology(param Vo) []*Node {
	...
	for key, typeIndices := range indices {
		...
		if aggregationConditions == nil {
			log.Fatal("aggregation conditions can'i18n nil")
		}
